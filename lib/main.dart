...
import 'package:sinhan/login_page/login_page_widget.dart';
...
class _MyAppState extends State<MyApp> {
  Stream<SinhanFirebaseUser> userStream;
  SinhanFirebaseUser initialUser;
  final authUserSub = authenticatedUserStream.listen((_) {});

  @override
  void initState() {
    super.initState();
    userStream = sinhanFirebaseUserStream()
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      supportedLocales: const [Locale('en', 'kr')],
